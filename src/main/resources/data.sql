...
-- VALUES (0, 'Beautiful', 'USA', 10, 0, 0);
-- INSERT INTO SONG (id, title, originating_country, genre, publisher_id, artist_id)
-- VALUES (1, 'Dota', 'Sweden', 20, 0, 1);
-- INSERT INTO SONG (id, title, originating_country, genre, publisher_id, artist_id)
-- VALUES (2, 'Poison', 'USA', 30, 1, 3);
-- INSERT INTO SONG (id, title, originating_country, genre, publisher_id, artist_id)
-- VALUES (3, 'A night in Tunisia', 'USA', 40, 1, 2);
-- INSERT INTO SONG (id, title, originating_country, genre, publisher_id, artist_id)
-- VALUES (4, 'Now you are gone', 'Sweden', 20, 1, 1);
